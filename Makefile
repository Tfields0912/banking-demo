...
PROGRAMS := reset-data create-user create-account account-inquiry withdraw-deposit bank-menu

.PHONY: all build reset clean menu create-user create-account account-inquiry withdraw-deposit
